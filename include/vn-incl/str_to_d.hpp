...
namespace vn {
	...
	template<detail::float_types v_type> VN_FORCE_INLINE std::from_chars_result from_chars(const char* first, const char* last, v_type& value, int32_t base = 10) noexcept {
		if (base == 10) {
