...
namespace vn {
	...
	namespace detail {// SPDX-License-Identifier: MIT
// Copyright (c) 2026 Nihilai Collective Corp
// vn-incl/utility.hpp
...
namespace vn {
	...
	namespace detail {
		...
		template<integer_types v_type> VN_FORCE_INLINE static v_type count_trailing_decimal_zeros(v_type n) noexcept {
			if (n == 0) {
				return 1;
			}
